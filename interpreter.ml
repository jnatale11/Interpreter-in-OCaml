(*******************************************************************
    ...
    calculator language, and interpreter for the
    generated syntax trees.  

    For CSC 254, Fall 2016
    Assignment 3                                                                 
    Jason Natale

    Some of the code utilized in my project is example code from the course webpage, written by Michael Scott.                                                                 
...
(* Building abstract syntax tree out of parse tree*)
...
and ast_ize_SL (sl:parse_tree) : ast_sl =
  ...
  | PT_nt ("SL", s::sl) -> ast_ize_S s
    (*let (ast_slflist = ast_ize_S s in
      flist @ ast_ize_SL sl*)
  (*
     your code here ...
  *)
